        ...
        <section className='px-4 pt-20 pb-12 sm:px-8 sm:pt-28 sm:pb-16 md:px-16 md:pt-40 md:pb-24 lg:px-28 xl:px-32'>
          <div className='mx-auto max-w-6xl'>
            ...
            <div className='mb-12 text-center sm:mb-16'>
              ...
              >
                Meet the amazing people who have helped build and improve Open Kernel
              </motion.p>
            </div>
                ...
                <div className='space-y-1'>
                  <div className='flex items-center gap-2'>
                    <div className='relative h-6 w-6 sm:h-8 sm:w-8'>
                      <Image
                        src='/favicon.ico'
                        alt='Open Kernel Logo'
                        className='object-contain'
                        width={32}
                        height={32}
                      />
                    </div>
                    <h2 className='font-semibold text-lg text-white sm:text-xl'>Open Kernel</h2>
                  </div>
