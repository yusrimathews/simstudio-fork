...
export const getUserWorkflowTool: ToolConfig<GetWorkflowParams, GetWorkflowResponse> = {
  ...
  description:
    "Get the current user's specific workflow (not general Open Kernel documentation). Returns YAML format showing only the blocks that the user has actually built in their workflow, with their specific configurations, inputs, and connections.",
  version: '1.0.0',
